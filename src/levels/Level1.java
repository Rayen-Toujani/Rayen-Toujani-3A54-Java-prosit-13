...
public class Level1 {
    ...
    public static void main(String[] args) {
         ...
         */
        employees.stream().filter(teacher -> teacher.getName().startsWith("n")).filter(teacher -> teacher.getSalary()>100000).forEach(System.out::println);

        /*
         * TO DO 4: Afficher les enseignants JAVA triés par salaire (éliminer les redondances)
         */
        employees.stream().filter(teacher -> teacher.getSubject().equals("JAVA")).sorted().forEach(System.out::println);
